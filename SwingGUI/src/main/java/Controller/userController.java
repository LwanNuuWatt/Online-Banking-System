...
public class userController {
    ...
    {
        String query = "INSERT INTO tbl_customer_test " +
    ...
    {
        String query = "SELECT Password,Salt,Status FROM tbl_customer_test WHERE PhoneNo = ?";
    ...
    {
        String deleteQuery = "delete from tbl_customer_test where PhoneNo=?";
    ...
    {
        String query = "SELECT * FROM tbl_customer_test WHERE PhoneNo = ?";
    ...
    {
        String query = "update tbl_customer_test set Name=?,PhoneNo=? where Id=?";
    ...
    {
        String query = "update tbl_customer_test set Password=? where PhoneNo=?";
    ...
    {
        String query = "update tbl_customer_test set Amount=? where PhoneNo=?";
    ...
    {
        String query = "update tbl_customer_test set Status=? where PhoneNo=?";
